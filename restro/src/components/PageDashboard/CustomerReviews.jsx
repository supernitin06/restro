    ...
    <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20">
      ...
      <div className="relative overflow-hidden">
        ...
        {canScrollLeft && (
          <button
            onClick={() => scroll('left')}
            className="absolute left-2 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-50 transition-all hover:scale-110"
          >
        ...
        <div className="w-full overflow-hidden">
          ...
          {reviews.map((review) => (
            <div
              key={review.id}
              className="w-[45%] flex-shrink-0 bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 group"
            >
              <div className="flex items-start gap-4 mb-4">
                <div className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${review.gradient} flex items-center justify-center text-4xl shadow-md group-hover:scale-110 transition-transform`}>
                  {review.image}
                </div>
                <div className="flex-1">
                  <h4 className="font-bold text-gray-800 text-lg mb-1">{review.dishName}</h4>
                  <div className="flex items-center gap-1 mb-2">
                    ...
                    <span className="text-sm font-semibold text-gray-700 ml-1">{review.rating}</span>
                  </div>
                </div>
              </div>
        ...
        {canScrollRight && (
          <button
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-50 transition-all hover:scale-110"
          >
