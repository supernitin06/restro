            ...
            <Card key={partnerId} className="p-3.5 group hover:border-primary/50 transition-all duration-300 hover:shadow-md cursor-pointer" onClick={() => onViewDetails(partner)}>
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                ...
                <div className="md:col-span-2 text-xs flex flex-col gap-1">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">KYC: <span className={`font-bold ${listView.kycStatus === 'VERIFIED' || listView.kycStatus === 'APPROVED' ? 'text-green-500' :
            ...
            >
              ...
              <div className="p-3 bg-white dark:bg-gray-800">
                <div className="grid grid-cols-2 gap-2">
                  <Button variant="primary" size="sm" className="text-[10px] h-8 py-0" onClick={(e) => { e.stopPropagation(); handleViewOrders(partner.partnerId); }}>
                    View Order
                  </Button>
                  <Button
