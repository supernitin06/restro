  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      await addMenu({
        ...
        pricingOptions, // ✅ Fix: Send pricingOptions to API
        image: imagePayload,
        altText,
      }).unwrap();
                  ...
                  <div className="flex flex-wrap gap-3">
                    {tagOptions.map((tag) => {
                      ...
                      <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2.5 rounded-xl border-2 text-sm font-bold transition-all duration-200 shadow-sm ${
                          isSelected
